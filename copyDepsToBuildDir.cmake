...
set(RTTR_SOURCE_DIR "@RTTR_SOURCE_DIR@")
...
file(COPY "${RTTR_SOURCE_DIR}/data/RTTR" DESTINATION "${RTTR_OUTPUT_PATH}")

set(S2_GAME_PATHS ${RTTR_SOURCE_DIR} ${RTTR_SOURCE_DIR}/S2)
